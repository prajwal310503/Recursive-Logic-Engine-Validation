import { Play, X, Share2, GitBranch } from 'lucide-react';
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 24px 64px rgba(0,0,0,0.8), 0 0 48px rgba(16,185,129,0.06), inset 0 1px 0 rgba(255,255,255,0.08)',
        }}
      ...
      >
        ...
        <ol className="max-h-96 overflow-y-auto px-5 py-4 space-y-2.5">
          {steps.map((step, i) => (
            ...
            >
              ...
              {/* Content */}
              <div className="flex-1 rounded-xl px-4 py-3 min-w-0"
              ...
              >
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                  ...
                  {i === 0 && (
                    ...
                    >
                      <GitBranch size={9} /> root
                    </span>
                  )}

                  {step.depth > 0 && (
                    <span className="text-[10px] text-slate-600">depth {step.depth}</span>
                  )}
                </div>
                <p className="text-sm">
        ...
        >
          <p className="text-[11px] text-slate-600">Nodes reachable from root · depth-first order</p>
          <button onClick={onClose}
